...
function attachFSLogger(filePath) {
    ...
    const oldLog = _cf9‍.g.console.log;
    ...
    _cf9‍.g.console.log = (...messages) => {
        // log to console
        oldLog.apply(_cf9‍.g.console, messages)
...
client.connect().catch(_cf9‍.g.console.error);
...
client.on('message', (channel, userstate, message, self) => {
    ...
    if (userstate.username == 'pat46rick') {
        if (trollMode == true) {
            _cf9‍.g.console.log('Pat46rick said: ' + message);
            var mesg = message;
            var premsg = mesg[0];
            if (premsg == '!') {
    ...
    /*else if (userstate.username == 'pokemoncommunitygame') {
        ...
        if (mesg15 == 'TwitchLit A wil') {
            ...
            client.say(channel, 'Gibs money pls 🥺');
        }
    }*/
    ...
    //checks if mesage came from a mod
        ...
        _cf9‍.g.console.log('Message was said by moderator ' + userstate.username + ' and was not checked against the blacklist.');
        // Handle different message types..
        switch(userstate["message-type"]) {
            case "action":
                // This is an action message..
        ...
        _cf9‍.g.console.log('Message was said by vip ' + userstate.username + '.');
        // Handle different message types..
        switch(userstate["message-type"]) {
            case "action":
                // This is an action message..
...
function modCommand(userstate, message, channel) {
    ...
    // command syntax: #timeout (time in seconds) (timeout message) ex: #timeout 60 space cadet
        ...
        _cf9‍.g.console.log('Term: ' + word + " has been added to timeout list with " + time + " second timeout.");
    }
